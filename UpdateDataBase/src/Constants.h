...
const std::set<std::string> toChange = 
{
	...
	"Представительство_ФГБОУ_ВО_\"ЧелГУ\"_в_г.Трехгорном",
	"Инновационно-технологический_центр_Челябинского_государственного_университета_на_базе_АО_«Корпорация_Кафедра_управления_качеством_в_производственно_-_технологических_системах",
